# AtomUI.Icons.IconPark Introduction

AtomUI.Icons.IconPark is an icon library wrapper for the AtomUI OSS framework, built on the ByteDance IconPark project. It provides a unified API and naming conventions, enabling you to use the full style and semantics of native IconPark icons within AtomUI.

## Key Features
- Covers common IconPark themes: Outline / Filled / TwoTone / Multi-color
