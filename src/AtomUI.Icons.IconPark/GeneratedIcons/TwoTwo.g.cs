...
public class TwoTwo : IconParkIcon
{
    public TwoTwo()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(9.1707199999999993, 3, 31.329280000000001, 41);
