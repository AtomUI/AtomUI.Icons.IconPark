...
public class Dongchedi : IconParkIcon
{
    public Dongchedi()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3, 7, 42, 33.689300000000003);
