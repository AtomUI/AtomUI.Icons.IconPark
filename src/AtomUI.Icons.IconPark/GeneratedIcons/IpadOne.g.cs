...
public class IpadOne : IconParkIcon
{
    public IpadOne()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(5, 10, 38, 30);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            ...
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M11 27V23"),
        },
    ];
