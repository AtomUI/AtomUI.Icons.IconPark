...
public class Youtube : IconParkIcon
{
    public Youtube()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4.9980500000000001, 10, 37.999949999999998, 28);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.1162284501051696, 0, 0, 1.1162284501051696, -2.7894828025240699, -2.7894828025240699);
