...
public class Easy : IconParkIcon
{
    public Easy()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(7, 4, 34, 40.002600000000001);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0909735575283994, 0, 0, 1.0909735575283994, -2.183365380681586, -2.183365380681586);
