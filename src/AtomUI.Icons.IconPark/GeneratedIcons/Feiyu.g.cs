...
public class Feiyu : IconParkIcon
{
    public Feiyu()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2, 12.988099999999999, 43.773299999999999, 22.261500000000002);
