...
public class HospitalThree : IconParkIcon
{
    public HospitalThree()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(2.8047399999999998, 2, 42.390560000000001, 42);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M11 26L11 44L37 44L37 26L24 13L11 26Z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
        ...
        new PathDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M19 31L29 31"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M24 26V36"),
        },
    ];
