...
public class Five : IconParkIcon
{
    public Five()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 4.4328099999999999, 39.498899999999999, 39.567189999999997);
