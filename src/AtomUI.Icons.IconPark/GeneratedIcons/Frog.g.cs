...
public class Frog : IconParkIcon
{
    public Frog()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new CircleDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = false,
            IsStrokeEnabled = false,
            Center = new Avalonia.Point(20.1562, 28.5762),
            Radius = 2
        },
        new CircleDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = false,
            IsStrokeEnabled = false,
            Center = new Avalonia.Point(28.1562, 28.5762),
            Radius = 2
        },
        new CircleDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = false,
            IsStrokeEnabled = false,
            Center = new Avalonia.Point(36, 17),
            Radius = 2
        },
    ];
