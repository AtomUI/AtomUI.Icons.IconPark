...
public class InnerShadowTopRight : IconParkIcon
{
    public InnerShadowTopRight()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = false,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M38 24C38 20.134 36.4329 16.634 33.8996 14.1005C31.366 11.567 27.866 10 24 10"),
        },
    ];
