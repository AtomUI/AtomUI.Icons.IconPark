...
public class FolderProtectionOne : IconParkIcon
{
    public FolderProtectionOne()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M28 30.8C28 29.8667 34 28 34 28C34 28 40 29.8667 40 30.8C40 38.2667 34 42 34 42C34 42 28 38.2667 28 30.8Z"),
        },
    ];
