...
public class Three : IconParkIcon
{
    public Three()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(5.7603999999999997, 4.4328099999999999, 33.352600000000002, 39.567189999999997);
