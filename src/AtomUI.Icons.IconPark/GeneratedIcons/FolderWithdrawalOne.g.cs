...
public class FolderWithdrawalOne : IconParkIcon
{
    public FolderWithdrawalOne()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(5, 6, 38, 37);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M32 33L27 38L32 43"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M27 38H43V30"),
        },
    ];
