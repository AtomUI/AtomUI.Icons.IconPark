...
public class HandUp : IconParkIcon
{
    public HandUp()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(6.3349099999999998, 4, 34.665190000000003, 40);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M41 38H19V44H41V38Z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
