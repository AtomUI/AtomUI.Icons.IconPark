...
public class PullDoor : IconParkIcon
{
    public PullDoor()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(6, 4, 36.0002, 40);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M6 8V40L24.2 44V4L6 8Z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M24.2002 8H42.0002V40H24.2002"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
