...
public class HandLeft : IconParkIcon
{
    public HandLeft()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 6.2541900000000004, 40, 34.746009999999998);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M44 41V19H38V41H44Z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
