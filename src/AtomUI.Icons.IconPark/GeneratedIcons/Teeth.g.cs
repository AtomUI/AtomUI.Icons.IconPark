...
public class Teeth : IconParkIcon
{
    public Teeth()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(3.7659699999999998, 5, 40.23433, 38);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.0851373930885337, 0, 0, 1.0851373930885337, -2.0432974341248098, -2.0432974341248098);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = false,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M15.4824 12.4634L32.0005 17.7887"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
            ...
            IsStrokeLinejoinCustomizable = false,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M15.4824 17.7886L32.0005 12.4632"),
        },
    ];
