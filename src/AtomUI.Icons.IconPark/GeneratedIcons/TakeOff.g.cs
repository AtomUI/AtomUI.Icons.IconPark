...
public class TakeOff : IconParkIcon
{
    public TakeOff()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 15, 40, 26);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M22.0007 29L18.0003 31L23.0003 41L32.0003 24"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M17 25L12 16L28 20"),
        },
    ];
