...
public class Germs : IconParkIcon
{
    public Germs()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M29 29.0002C31.2091 29.0002 33 27.2094 33 25.0002C33 22.7911 31.2091 21.0002 29 21.0002C26.7909 21.0002 25 22.7911 25 25.0002C25 27.2094 26.7909 29.0002 29 29.0002Z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
            ...
            Data = StreamGeometry.Parse("M16.5 26.0002C17.8807 26.0002 19 24.881 19 23.5002C19 22.1195 17.8807 21.0002 16.5 21.0002C15.1193 21.0002 14 22.1195 14 23.5002C14 24.881 15.1193 26.0002 16.5 26.0002Z"),
        },
    ];
