...
public class Experiment : IconParkIcon
{
    public Experiment()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(5.48698, 4, 36.573319999999995, 40);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M12 4H36"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
            ...
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M10.7769 30L18.019 15.0386V4H30.0283V15.0386L37.246 30"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
