...
public class GiftBox : IconParkIcon
{
    public GiftBox()
    {
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        new PathDrawingInstruction()
        {
            ...
            Data = StreamGeometry.Parse("M6 9C6 7.34315 7.34315 6 9 6H24H39C40.6569 6 42 7.34315 42 9V24V39C42 40.6569 40.6569 42 39 42H24H9C7.34315 42 6 40.6569 6 39V24V9Z"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
        ...
        new PathDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M24 44V4"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M6 30V18"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M42 30V18"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M30 42H18"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M30 6H18"),
        },
        new PathDrawingInstruction()
        {
            Opacity = 1,
