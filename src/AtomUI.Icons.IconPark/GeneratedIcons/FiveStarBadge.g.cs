...
public class FiveStarBadge : IconParkIcon
{
    public FiveStarBadge()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(11.5426, 4, 24.9148, 39.768999999999998);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M36 4H12V14L24 19L36 14V4Z"),
        },
    ];
