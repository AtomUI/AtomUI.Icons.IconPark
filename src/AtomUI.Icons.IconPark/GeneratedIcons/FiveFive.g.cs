...
public class FiveFive : IconParkIcon
{
    public FiveFive()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(5.1316800000000002, 3, 36.868319999999997, 41);
