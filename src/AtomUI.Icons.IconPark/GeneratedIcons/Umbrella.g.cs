...
public class Umbrella : IconParkIcon
{
    public Umbrella()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(4, 3, 40, 41.011200000000002);
    ...
    private static readonly DrawingInstruction[] StaticInstructions = [
        ...
        new PathDrawingInstruction()
        {
            ...
            IsStrokeLinejoinCustomizable = true,
            IsStrokeEnabled = true,
            Data = StreamGeometry.Parse("M24 3V7"),
        },
    ];
