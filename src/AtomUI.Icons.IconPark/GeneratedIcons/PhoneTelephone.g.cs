...
public class PhoneTelephone : IconParkIcon
{
    public PhoneTelephone()
    {
    ...
    internal override Rect GeneratedGeometryBounds => new Rect(7.4737499999999999, 7.6858300000000002, 33.32705, 33.327069999999999);
    internal override Matrix GeneratedZoomMatrix => new Matrix(1.1988131749567927, 0, 0, 1.1988131749567927, -4.7715161989630275, -4.7715161989630275);
