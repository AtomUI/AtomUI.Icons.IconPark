...
namespace AtomUI.Theme.Language
{
    internal class LanguageProviderPool
    {
        internal static IList<LanguageProvider> GetLanguageProviders()
        {
            ...
            languageProviders.Add(new IconParkGallery.Workspace.Localization.WorkspaceWindowLang.en_US());
            languageProviders.Add(new IconParkGallery.Workspace.Localization.WorkspaceWindowLang.zh_CN());
